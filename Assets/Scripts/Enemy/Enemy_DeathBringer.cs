...
public class Enemy_DeathBringer : Enemy
{
    ...
    [SerializeField] private Vector2 surroundCheckSize;
    ...
    private bool SomethingIsAround() => Physics2D.BoxCast(transform.position, surroundCheckSize, 0, Vector2.zero, whatIsGround);
    ...
    protected override void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(transform.position, surroundCheckSize);
    }
